...
1. 从 [Releases](https://github.com/tuzibuqiahuluobo/yanami-sub/releases) 下载
   `Yanami-Sub-0.1.0-rc.6.post8-Setup.exe`。
...
> `v0.1.0-rc.6.post8`（RC6.8）统一深色界面的低眩光灰阶，并修复使用 SOCKS 代理
> 下载 AI 模型时缺少 `socksio` 的错误。现有 RC6.7 可在“应用更新”中升级；
> RC6.6 若因 WinError 448 无法打开，请下载 RC6.8 安装器覆盖安装，无需卸载或清理数据。
